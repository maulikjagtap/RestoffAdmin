...
class RestaurantHorizontalrvAdepter  extends RecyclerView.Adapter<RestaurantHorizontalrvAdepter.SubHolder> {
    private Context context;
    private ArrayList<Horizontalmodel> horizontalmodelArrayList;
    private FirebaseAuth firebaseAuth;
    private FirebaseDatabase firebaseDatabase;
    private DatabaseReference databaseReference;
    public RestaurantHorizontalrvAdepter(Context context, ArrayList<Horizontalmodel> horizontalmodelArrayList) {
    ...
    @NonNull
    @Override
    public RestaurantHorizontalrvAdepter.SubHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.horizontalsubrow,viewGroup,false);
        return new RestaurantHorizontalrvAdepter.SubHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RestaurantHorizontalrvAdepter.SubHolder subHolder, int i) {
        ...
        final Query query= databaseReference.child("restaurantIteams").child(firebaseAuth.getCurrentUser().getUid()).orderByChild("name").equalTo(horizontalmodel.getName());
