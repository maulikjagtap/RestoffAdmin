...
class GymHorizontalrvAdepter extends RecyclerView.Adapter<GymHorizontalrvAdepter.SubHolder> {
    private Context context;
    private ArrayList<Horizontalmodel> horizontalmodelArrayList;
    private FirebaseAuth firebaseAuth;
    private FirebaseDatabase firebaseDatabase;
    private DatabaseReference databaseReference;
    public GymHorizontalrvAdepter(Context context, ArrayList<Horizontalmodel> horizontalmodelArrayList) {
    ...
    public SubHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new GymHorizontalrvAdepter.SubHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull SubHolder subHolder, int i) {
        ...
        final Query query= databaseReference.child("GymIteams").child(firebaseAuth.getCurrentUser().getUid()).orderByChild("name").equalTo(horizontalmodel.getName());
