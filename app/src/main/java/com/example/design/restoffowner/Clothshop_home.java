...
public class Clothshop_home extends Fragment {
   private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.clothshop_home,container,false);
        mainrecycle = view.findViewById(R.id.clothrecycle);
        ...
        final MainclothAdepter mainclothAdepter = new MainclothAdepter(getContext(), verticalModelArrayList);

        mainrecycle.setAdapter(mainclothAdepter);
...
//                    Toast.makeText(getActivity(), ""+iteamkey, Toast.LENGTH_SHORT).show();
                    ...
                    databaseReference.child("ClothIteams").child(firebaseAuth.getCurrentUser().getUid())
...
//
                            ...
                            mainclothAdepter.notifyDataSetChanged();
