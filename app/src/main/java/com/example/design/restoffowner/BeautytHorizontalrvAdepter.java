...
class BeautytHorizontalrvAdepter extends RecyclerView.Adapter<BeautytHorizontalrvAdepter.SubHolder> {
    private Context context;
    private ArrayList<Horizontalmodel> horizontalmodelArrayList;
    private FirebaseAuth firebaseAuth;
    private FirebaseDatabase firebaseDatabase;
    private DatabaseReference databaseReference;
    public BeautytHorizontalrvAdepter(Context context, ArrayList<Horizontalmodel> horizontalmodelArrayList) {
    ...
    @NonNull
    @Override
    public BeautytHorizontalrvAdepter.SubHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.horizontalsubrow,viewGroup,false);
        return new BeautytHorizontalrvAdepter.SubHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BeautytHorizontalrvAdepter.SubHolder subHolder, int i) {
        ...
        final Query query= databaseReference.child("BeautyIteams").child(firebaseAuth.getCurrentUser().getUid()).orderByChild("name").equalTo(horizontalmodel.getName());
